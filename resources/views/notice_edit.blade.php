...
@section('contents')
  <div class="contents">
    ...
    <div class="contents-body">
      <form action="/notice/{{$notice->id}}" method="post" onsubmit="return formcheck();">
        @method('PUT')
        @csrf
        <div class="contents-content">
          <table>
              ...
              <td>
                <input type="text" oninput="return check_input(this);" class="form-control-sm form-control" name="title" value="{{$notice->title}}" placeholder="제목을 입력해주세요.">
              </td>
            </tr>
            <tr>
              <th>내용 <span class="need">*</span></th>
              <td>
                <textarea id="summernote" name="content" oninput="return check_input(this);" rows="8" class="form-control-sm form-control">{{$notice->content}}</textarea>
              </td>
            </tr>
          </table>
        </div>
